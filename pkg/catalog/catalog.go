...
// staticImages are the hand-maintained catalog entries (cloud images,
// appliance ISOs). The full catalog appends generatedISOs (regenerated by
// scripts/regen-catalog.py — `just regen-catalog`).
...
// Images is the full image catalog: static entries plus the freshness-filtered
// Universal Blue / Aurora installer ISOs from catalog_generated.go.
var Images = append(append([]Image{}, staticImages...), generatedISOs...)
